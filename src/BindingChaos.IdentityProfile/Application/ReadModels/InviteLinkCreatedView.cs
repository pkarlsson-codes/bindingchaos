...
/// <summary>
/// The result of a successful <see cref="Commands.CreateInviteLink"/> command.
/// </summary>
...
public sealed record InviteLinkCreatedView(Guid Id, string Token, string? Note, DateTimeOffset CreatedAt);
