...
public interface ISocietiesApiClient
{
    ...
    Task<PaginatedResponse<SocietyListItemResponse>> GetSocietiesAsync(PaginationQuerySpec<SocietiesQueryFilter> query, CancellationToken cancellationToken = default);
    ...
    Task<SocietyResponse> GetSocietyAsync(string societyId, CancellationToken cancellationToken = default);
    ...
    Task<PaginatedResponse<SocietyMemberResponse>> GetSocietyMembersAsync(string societyId, PaginationQuerySpec<EmptyFilter> query, CancellationToken cancellationToken = default);
    ...
    Task<string> CreateSocietyAsync(CreateSocietyRequest request, CancellationToken cancellationToken = default);
    ...
    Task<string> JoinSocietyAsync(string societyId, JoinSocietyRequest request, CancellationToken cancellationToken = default);
    ...
    Task<string[]> GetMySocietyIdsAsync(CancellationToken cancellationToken = default);
    ...
    Task LeaveSocietyAsync(string societyId, CancellationToken cancellationToken = default);
}
