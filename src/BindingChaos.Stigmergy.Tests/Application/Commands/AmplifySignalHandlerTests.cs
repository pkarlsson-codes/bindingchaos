...
public class AmplifySignalHandlerTests
{
    ...
    public class TheHandleMethod
    {
        ...
        public async Task GivenSignalNotFound_WhenHandled_ThenThrowsAggregateNotFoundException()
        {
            ...
            var command = new AmplifySignal(ParticipantId.Generate(), SignalId.Generate());
        ...
        [Fact]
        public async Task GivenValidCommand_WhenHandled_ThenCommits()
        {
            ...
            testBed.SignalRepository
                ...
                .ReturnsAsync(signal);
            var command = new AmplifySignal(ParticipantId.Generate(), signal.Id);
        ...
        [Fact]
        public async Task GivenAlreadyAmplifiedByParticipant_WhenHandled_ThenThrowsBusinessRuleViolationException()
        {
            ...
            testBed.SignalRepository
                .Setup(r => r.GetByIdOrThrowAsync(signal.Id, It.IsAny<CancellationToken>()))
                .ReturnsAsync(signal);
            var command = new AmplifySignal(actorId, signal.Id);
