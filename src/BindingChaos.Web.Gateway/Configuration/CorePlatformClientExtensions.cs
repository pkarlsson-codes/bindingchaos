...
internal static class CorePlatformClientExtensions
{
    ...
    public static IServiceCollection AddCorePlatformClients(this IServiceCollection services, ConfigurationManager configuration)
    {
        ...
        services.AddIdeasApiClient(corePlatformBaseAddress)
            .AddHttpMessageHandler<InternalGatewayAuthHandler>();
        services.AddProjectsApiClient(corePlatformBaseAddress)
            .AddHttpMessageHandler<InternalGatewayAuthHandler>();
        services.AddConcernsApiClient(corePlatformBaseAddress)
            .AddHttpMessageHandler<InternalGatewayAuthHandler>();
        ...
        services.AddEmergingPatternsApiClient(corePlatformBaseAddress)
            .AddHttpMessageHandler<InternalGatewayAuthHandler>();
        services.AddCommonsApiClient(corePlatformBaseAddress)
            .AddHttpMessageHandler<InternalGatewayAuthHandler>();
