...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Gets the identifier of the user group that owns this project.
    /// </summary>
    public UserGroupId UserGroupId { get; private set; }

    /// <summary>
    /// Gets the amendments proposed against this project.
    /// </summary>
    public IReadOnlyList<Amendment> Amendments => _amendments.AsReadOnly();

    /// <summary>
    /// Gets the resource requirements for this project.
    /// </summary>
