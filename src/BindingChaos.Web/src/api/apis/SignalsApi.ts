...
export interface GetSignalsRequest {
    ...
    filterCapturedByParticipantId?: string | null;
    pageNumber?: number;
    pageSize?: number;
...
export interface SignalsApiInterface {
     ...
     * @param {string} [filterCapturedByParticipantId] Optional participant ID to filter signals captured by that participant.
...
export class SignalsApi extends runtime.BaseAPI implements SignalsApiInterface {
    ...
    async getSignalsRaw(requestParameters: GetSignalsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiResponseOfSignalsFeedViewModel>> {
        ...
        if (requestParameters['filterCapturedByParticipantId'] != null) {
            queryParameters['Filter.CapturedByParticipantId'] = requestParameters['filterCapturedByParticipantId'];
        }
